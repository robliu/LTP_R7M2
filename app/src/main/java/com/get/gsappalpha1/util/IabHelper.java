...
package com.get.gsappalpha1.util;
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                logDebug("Null oldSkus; calling getBuyIntent() for Sku = " + sku);
            ...
            logDebug("getResponseCodeFromBundle() returned response = " + response);
            ...
            logDebug("Preping buy intent for " + sku + ". Request code: " + requestCode);
            logDebug("Launching buy intent - details:" + pendingIntent);
            ...
            logDebug("Intent launched; Request code: " + requestCode);
        }
